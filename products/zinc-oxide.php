...
<head>
    ...
    <meta name="description" content="Buy high-purity Zinc Oxide (ZnO) from Bhatti Chemicals Industry — 99.9% purity, ISO 9001:2015 certified, packed in 25 kg bags. Manufactured in Gujranwala, Pakistan. Used in rubber, ceramics, paints, pharmaceuticals, and more.">
    <meta name="keywords" content="Zinc Oxide manufacturer Pakistan, buy zinc oxide, high purity zinc oxide, zinc oxide for rubber, zinc oxide for ceramics, zinc oxide 99.9%, zinc oxide Gujranwala, ZnO supplier Pakistan, ISO certified zinc oxide">
    ...
    *, *::before, *::after { box-sizing: border-box; margin:0; padding:0; }
    ...
    .process-icon { font-size: 1.6rem; margin-bottom: 12px; }
    ...
    .application-card:hover { box-shadow: 0 6px 24px rgba(0,0,0,0.09); }
    .application-img {
    ...
    @media (max-width: 768px) {
      ...
      .quality-img-full { grid-column: auto; }
...
<section class="quality-section" id="specifications">
  <div class="quality-grid">
    ...
    <div class="quality-visuals reveal">
      <figure class="quality-img-card quality-img-full">
      ...
      <figure class="quality-img-card">
        <img src="<?php echo site_url('/assets/images/products/zinc-oxide-bg.jpg'); ?>"
             alt="Zinc Oxide production — Bhatti Chemicals Industry"
             loading="lazy">
        <figcaption>Zinc Oxide production facility</figcaption>
      </figure>
      <div class="lab-report-card zoomable-card" data-img="<?php echo site_url('/assets/images/products/zinc-oxide-lab-report.jpg'); ?>">
        <img src="<?php echo site_url('/assets/images/products/zinc-oxide-lab-report.jpg'); ?>" alt="Lab Report" class="lab-report-thumb">
  ...
  <!-- Production video -->
  <div style="max-width:1200px; margin: 60px auto 0; border-radius:14px; overflow:hidden; box-shadow:0 4px 24px rgba(0,0,0,0.08);" class="reveal">
    <video src="<?php echo site_url('/assets/videos/zinc-oxide-furnace.mp4'); ?>" autoplay loop muted playsinline
           aria-label="Zinc Oxide production furnace — Bhatti Chemicals Industry"
           style="width:100%; display:block; aspect-ratio:16/6; object-fit:cover;">
    </video>
  </div>
</section>
...
<section class="process-section">
  ...
  <div class="process-steps">
    <div class="process-step reveal">
      ...
      <div class="process-icon" aria-hidden="true"><i class="fa-solid fa-magnifying-glass"></i></div>
    ...
    <div class="process-step reveal">
      ...
      <div class="process-icon" aria-hidden="true"><i class="fa-solid fa-fire"></i></div>
    ...
    <div class="process-step reveal">
      ...
      <div class="process-icon" aria-hidden="true"><i class="fa-solid fa-wind"></i></div>
    ...
    <div class="process-step reveal">
      ...
      <div class="process-icon" aria-hidden="true"><i class="fa-solid fa-flask-vial"></i></div>
    ...
    <div class="process-step reveal">
      ...
      <div class="process-icon" aria-hidden="true"><i class="fa-solid fa-box"></i></div>
    ...
    <div class="process-step reveal">
      ...
      <div class="process-icon" aria-hidden="true"><i class="fa-solid fa-warehouse"></i></div>
...
<section class="applications-section" id="applications">
  ...
  <div class="applications-list">
    <article class="application-card reveal">
      <img src="<?php echo site_url('/assets/images/icons/applications/tire.jpg'); ?>" alt="Zinc Oxide used in rubber and tyre manufacturing" class="application-img" loading="lazy">
    ...
    <article class="application-card reveal">
      <img src="<?php echo site_url('/assets/images/icons/applications/cosmatic.jpg'); ?>" alt="Zinc Oxide used in cosmetics and skincare" class="application-img" loading="lazy">
      <div class="application-body">
    ...
    <article class="application-card reveal">
      <img src="<?php echo site_url('/assets/images/icons/applications/medicine.avif'); ?>" alt="Zinc Oxide used in pharmaceuticals and ointments" class="application-img" loading="lazy">
      <div class="application-body">
    ...
    <article class="application-card reveal">
      <img src="<?php echo site_url('/assets/images/icons/applications/paints.jpg'); ?>" alt="Zinc Oxide used in paints and coatings" class="application-img" loading="lazy">
      <div class="application-body">
    ...
    <article class="application-card reveal">
      <img src="<?php echo site_url('/assets/images/icons/applications/feed.jpg'); ?>" alt="Zinc Oxide used in animal feed and agriculture" class="application-img" loading="lazy">
      <div class="application-body">
...
<section class="related-section">
  ...
  <div class="related-grid">
    <a href="<?php echo site_url('/products/zinc-ash.php'); ?>" class="related-card reveal">
      <img src="<?php echo site_url('/assets/images/products/zinc-ash-fine.jpg'); ?>" alt="Zinc Ash Fine 65-70% — Bhatti Chemicals Industry" loading="lazy">
    ...
    <a href="<?php echo site_url('/products/zinc-ingot.php'); ?>" class="related-card reveal">
      <img src="<?php echo site_url('/assets/images/products/zinc-ingot.png'); ?>" alt="Zinc Ingot — Bhatti Chemicals Industry" loading="lazy">
      <div class="related-card-body">
        <h3>Zinc Ingot</h3>
    ...
    <a href="<?php echo site_url('/products/zinc-dross.php'); ?>" class="related-card reveal">
      <img src="<?php echo site_url('/assets/images/products/zinc-dross.jpg'); ?>" alt="Zinc Dross — Bhatti Chemicals Industry" loading="lazy">
      <div class="related-card-body">
        <h3>Zinc Dross</h3>
