...
<meta name="description" content="Buy Zinc Ash Fine (65–70% metallic zinc) from Bhatti Chemicals Industry — a trusted exporter based in Gujranwala, Pakistan. Consistent analysis, 25–50 kg bags, full export documentation. ISO 9001:2015 certified.">
<meta name="keywords" content="Zinc Ash Fine exporter Pakistan, buy zinc ash, zinc ash 65-70%, zinc ash Gujranwala, zinc recovery material, metallic zinc ash, zinc ash supplier Pakistan, export zinc ash">
<link rel="canonical" href="https://www.bhattichemicalsindustry.com.pk/products/zinc-ash.php">
<meta property="og:type" content="product">
<meta property="og:site_name" content="Bhatti Chemicals Industry">
<meta property="og:title" content="Zinc Ash Fine (65–70%) | Exporter | Bhatti Chemicals Industry, Pakistan">
<meta property="og:description" content="Zinc Ash Fine with 65–70% metallic zinc content. ISO 9001:2015 certified, consistent analysis, packed in 25–50 kg bags. International export from Gujranwala, Pakistan.">
<meta property="og:url" content="https://www.bhattichemicalsindustry.com.pk/products/zinc-ash.php">
...
<script type="application/ld+json">{"@context":"https://schema.org","@type":"Product","@id":"https://www.bhattichemicalsindustry.com.pk/products/zinc-ash.php#product","name":"Zinc Ash Fine (65–70%)","description":"Zinc Ash Fine with 65–70% metallic zinc content from Bhatti Chemicals Industry, Gujranwala, Pakistan. ISO 9001:2015 certified, packed in 25–50 kg bags, available for international export.","image":"https://www.bhattichemicalsindustry.com.pk/assets/images/products/zinc-ash-fine.jpg","url":"https://www.bhattichemicalsindustry.com.pk/products/zinc-ash.php","brand":{"@type":"Brand","name":"Bhatti Chemicals Industry"},"manufacturer":{"@type":"Organization","name":"Bhatti Chemicals Industry","address":{"@type":"PostalAddress","addressLocality":"Gujranwala","addressCountry":"PK"}},"category":"Zinc Ash","material":"Zinc","offers":{"@type":"Offer","url":"https://www.bhattichemicalsindustry.com.pk/contact-us.php","availability":"https://schema.org/InStock","itemCondition":"https://schema.org/NewCondition","priceSpecification":{"@type":"UnitPriceSpecification","price":"0.00","priceCurrency":"PKR","description":"Quote-based price confirmed after quantity and destination review; contact our team for current pricing."},"seller":{"@type":"Organization","name":"Bhatti Chemicals Industry"}}}</script>
...
/* HERO */
.page-hero{position:relative;min-height:58vh;background:#1a0e00;display:flex;align-items:flex-end;padding:120px 24px 60px;overflow:hidden}
.page-hero::before{content:'';position:absolute;inset:0;background:radial-gradient(ellipse 65% 60% at 75% 35%,rgba(200,146,42,.28) 0%,transparent 65%),radial-gradient(ellipse 40% 50% at 5% 85%,rgba(140,90,20,.18) 0%,transparent 60%)}
.hero-bg-text{position:absolute;right:0;top:50%;transform:translateY(-50%);font-family:'Sora',sans-serif;font-size:clamp(130px,17vw,280px);font-weight:800;color:rgba(255,255,255,.03);pointer-events:none;user-select:none;white-space:nowrap}
...
.breadcrumb a:hover{color:#f4c85a}
...
.hero-tag.highlight{background:rgba(200,146,42,.35);border-color:rgba(200,146,42,.5);color:#f4c85a}
...
/* OVERVIEW STRIP */
.overview-strip{background:#fff;border-top:3px solid #c8922a;border-bottom:1px solid #e2e8e0}
...
/* EXPORT SECTION */
.export-section{padding:90px 24px;background:#fff}
...
.export-img-card img:hover{transform:scale(1.02)}
.export-img-card figcaption{padding:8px 12px;font-size:.78rem;color:#6b7280;font-weight:500}
.export-img-full{grid-column:1/-1}
.export-img-full img{aspect-ratio:16/7}
...
/* APPLICATIONS */
.applications-section{padding:90px 24px;background:#1a0e00}
.applications-section .section-header .eyebrow{color:#f4c85a}
.applications-section .section-header h2{color:#fff}
.applications-section .section-desc{color:rgba(255,255,255,.65)}
...
/* WHY CHOOSE */
.why-section{padding:90px 24px;background:#f0f2f0}
...
<section class="page-hero" aria-label="Zinc Ash Fine product page">
  ...
  <div class="page-hero-inner">
    <nav class="breadcrumb" aria-label="Breadcrumb">
      ...
      <span aria-current="page">Zinc Ash Fine</span>
    </nav>
    <p class="eyebrow" style="color:#f4c85a;">Primary Export Product</p>
    <h1>Zinc Ash Fine<br>(65–70% Metallic Zinc)</h1>
    <div class="hero-tag-row">
      <span class="hero-tag highlight">ISO 9001:2015 Certified</span>
      <span class="hero-tag">25–50 kg Bags</span>
      <span class="hero-tag">65–70% Metallic Zinc</span>
      <span class="hero-tag">International Export</span>
      <span class="hero-tag">Gujranwala, Pakistan</span>
    </div>
    <p class="hero-desc">Bhatti Chemicals Industry is a trusted exporter of Zinc Ash Fine with consistent 65–70% metallic zinc content. Full laboratory analysis, ISO-compliant packaging, and complete export documentation with every shipment.</p>
    <div class="hero-ctas">
      <a href="#contact" class="btn-gold">Request Export Quote</a>
...
<div class="overview-strip" role="list" aria-label="Key product specifications">
  <div class="overview-inner">
    <div class="overview-item" role="listitem"><span class="overview-label">Zinc Content</span><span class="overview-value">65–70%</span><span class="overview-note">Metallic zinc (typical)</span></div>
    <div class="overview-item" role="listitem"><span class="overview-label">Physical Form</span><span class="overview-value">Powder/Flakes</span><span class="overview-note">Brownish fine material</span></div>
    <div class="overview-item" role="listitem"><span class="overview-label">Pack Size</span><span class="overview-value">25–50 kg</span><span class="overview-note">Custom sizes available</span></div>
...
<section class="export-section" id="about">
  <div class="export-grid">
    <div class="export-text reveal">
      <p class="eyebrow">Our Primary Export Product</p>
      <h2>Reliable Zinc Ash Fine Supply for International Buyers</h2>
...
<section class="specs-section" id="specifications">
  <div class="specs-grid">
    <div class="reveal">
      ...
      <h2>Zinc Ash Fine Specifications</h2>
      <p style="margin-bottom:1.5rem">Standard quality parameters for Zinc Ash Fine as supplied by Bhatti Chemicals Industry. Full certificates of analysis are available on request for each shipment.</p>
      <table class="specs-table" aria-label="Zinc Ash Fine quality specifications">
        <thead><tr><th>Parameter</th><th>Specification</th><th>Relevance</th></tr></thead>
        <tbody>
          <tr><td>Zinc Content (Metallic)</td><td class="good">65–70%</td><td>High-value zinc recovery feedstock</td></tr>
          <tr><td>Physical Form</td><td>Fine Powder / Flakes</td><td>Easy processing and smelting</td></tr>
          <tr><td>Moisture Content</td><td>≤ 1.0%</td><td>Storage stability and transport safety</td></tr>
          <tr><td>Particle Size</td><td>80% pass 100 mesh</td><td>Enhanced reactivity in processing</td></tr>
          <tr><td>Iron (Fe) Content</td><td>≤ 2.0%</td><td>Suitable for most recovery applications</td></tr>
          <tr><td>Lead (Pb) Content</td><td>≤ 1.5%</td><td>Meets international trade standards</td></tr>
          <tr><td>Chloride Content</td><td>≤ 0.5%</td><td>Minimises corrosion risks in processing</td></tr>
          <tr><td>Standard Pack Size</td><td>25–50 kg bags</td><td>Flexible for container and bulk orders</td></tr>
        </tbody>
      </table>
    </div>
    <div class="reveal" style="padding-top:2rem">
      ...
      <p style="margin-top:1rem;font-size:.82rem;color:#9ca3af">+ Other destinations available. Contact us with your country and requirements.</p>
    </div>
  </div>
</section>
...
<section class="process-section">
  <div class="section-header reveal">
    <p class="eyebrow">Supply Process</p>
    <h2>How We Prepare and Export Zinc Ash Fine</h2>
    <p class="section-desc">A structured six-step process ensures consistent quality, accurate documentation, and reliable delivery for every international Zinc Ash Fine shipment.</p>
  </div>
  <div class="process-steps">
    <div class="process-step reveal"><div class="step-num">01</div><h3>Collection &amp; Sourcing</h3><p>Zinc ash is carefully collected from galvanizing baths and zinc processing operations, ensuring a consistent and traceable source material.</p></div>
    <div class="process-step reveal"><div class="step-num">02</div><h3>Initial Screening</h3><p>Primary screening removes large impurities and foreign material to prepare the ash for fine processing.</p></div>
    <div class="process-step reveal"><div class="step-num">03</div><h3>Fine Processing</h3><p>Advanced screening techniques achieve the target particle size distribution (80% pass 100 mesh) and uniform material quality.</p></div>
    <div class="process-step reveal"><div class="step-num">04</div><h3>Laboratory Analysis</h3><p>Comprehensive testing of zinc content, moisture, iron, lead, chloride, and particle size is conducted and documented before approval for shipment.</p></div>
    <div class="process-step reveal"><div class="step-num">05</div><h3>Grading &amp; Classification</h3><p>Material is classified based on zinc content and quality parameters to match buyer specifications and order requirements.</p></div>
    <div class="process-step reveal"><div class="step-num">06</div><h3>Packaging &amp; Documentation</h3><p>Packed in 25–50 kg bags with full export documentation: certificate of analysis, packing list, bill of lading, and any buyer-specified compliance certificates.</p></div>
  </div>
</section>
...
<section class="applications-section">
  <div class="section-header reveal">
    ...
    <h2>Applications of Zinc Ash Fine</h2>
...
<section class="faq-section">
  <div class="section-header reveal"><p class="eyebrow">Common Questions</p><h2>Zinc Ash Fine — Frequently Asked Questions</h2></div>
  <div class="faq-list">
    <?php
    $faqs = [
      ["What is the zinc content of your Zinc Ash Fine?","Bhatti Chemicals Industry's Zinc Ash Fine contains 65–70% metallic zinc (typical). Full laboratory analysis reports confirming zinc content and all other quality parameters are provided with every shipment."],
      ["Do you export Zinc Ash internationally?","Yes. Zinc Ash Fine is our primary export product. We supply international buyers in India, UAE, Saudi Arabia, China, UK, USA, Russia, Turkey, and other countries, providing complete export documentation and logistics support."],
      ["What packaging is used for Zinc Ash Fine?","Zinc Ash Fine is packed in standard 25–50 kg bags. Custom packaging arrangements — including bulk containers — are available for high-volume orders. Contact us to discuss your specific packaging requirements."],
      ["Is your Zinc Ash Fine ISO 9001:2015 certified?","Yes. Bhatti Chemicals Industry operates under an ISO 9001:2015 certified quality management system. Zinc Ash Fine is tested by laboratory analysis before dispatch and full certificates of analysis are available for each batch."],
      ["What applications is Zinc Ash Fine used for?","Zinc Ash Fine is used for metallic zinc recovery, zinc compound manufacturing, galvanizing industry feedstock, brass and alloy production, and as a raw material in chemical and fertilizer industries."],
      ["How do I request a quotation for Zinc Ash Fine?","Contact us at <a href=\"mailto:info@bhattichemicalsindustry.com.pk\">info@bhattichemicalsindustry.com.pk</a> or WhatsApp +92 304 1462460. Please include your required quantity, destination country, and any packaging preferences. We respond to all export inquiries promptly."],
    ];
    foreach($faqs as $faq): ?>
...
<section class="cta-strip">
  <h2>Request a Zinc Ash Fine Export Quote</h2>
  <p>Tell us your required quantity, destination, and packaging preference. We respond to all export inquiries within one business day.</p>
  <div class="cta-btn-row">
    <a href="#contact" class="btn-white">Contact Our Export Team</a>
    <a href="<?php echo site_url('/products/zinc-oxide.php'); ?>" class="btn-ghost-white">View Zinc Oxide →</a>
  </div>
</section>
